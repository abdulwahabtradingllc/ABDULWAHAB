    ...
    <section className="relative py-12 bg-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-black tracking-wide font-roboto">
        ...
        <motion.p
          ...
          className="text-gray-700 pb-8 text-sm sm:text-base md:text-lg max-w-2xl mx-auto font-light font-roboto"
        >
...
function SupplierCard({ img, name }) {
  return (
    ...
    >
      {/* 🟩 Polygon (Cut-Corner) Logo Container */}
      <div
        className="w-56 h-44 bg-white border-2 border-gray-200 hover:border-[#1A83C7]/60 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden flex items-center justify-center"
        style={{
          clipPath:
      ...
      >
        <img
          src={img}
          alt={name}
          className="w-44 h-36 object-contain transition-transform duration-300 hover:scale-105"
        />
      </div>

      {/* 🔖 Supplier Name */}
      <h3 className="mt-4 text-base sm:text-lg font-thin text-gray-700 font-roboto">
        {name}
      </h3>
    </motion.div>
  );
